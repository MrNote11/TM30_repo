...
UPDATED_FRONTEND_URL = env('UPDATED_FRONTEND_URL', None)
UPDATED_PAYMENT_INITIATOR = env('UPDATED_PAYMENT_INITIATOR', None)
UPDATED_PAYMENT_GATEWAY = env('UPDATED_PAYMENT_GATEWAY', None)
UPDATED_PAYMENT_KEY = env('UPDATED_PAYMENT_KEY', None)

UPDATED_SHIPPING_BASE_URL = env('UPDATED_SHIPPING_BASE_URL', None)
UPDATED_SHIPPING_EMAIL = env('UPDATED_SHIPPING_EMAIL', None)
UPDATED_SHIPPING_PASSWORD = env('UPDATED_SHIPPING_PASSWORD', None)
UPDATED_SHIPPING_TOKEN = env('UPDATED_SHIPPING_TOKEN', None)
UPDATED_SHIPPING_X_API_KEY = env('UPDATED_SHIPPING_X_API_KEY', None)

# Allow session cookies from different domains
SESSION_COOKIE_SAMESITE = None
SESSION_COOKIE_SECURE = True

HASHIDS_SALT = env("HASHIDS_SALT", None)
