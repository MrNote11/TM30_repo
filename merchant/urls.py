...
urlpatterns = [
    ...
    # store
    path('store/<str:merchant_code>/', views.MerchantStoreView.as_view(), name="merchant-products"),
    path('<str:merchant_code>/follow-unfollow/', views.FollowUnfollowAPIView.as_view(), name='follow_unfollow'),
