...
def get_bank_codes(token):
    ...
    try:
        ...
        merchant_logger.info(f"url: {response.url}, headers: {header}, response: {response.json()}")
        admin_logger.info(f"url: {response.url}, headers: {header}, response: {response.json()}")
...
def payment_for_wallet(**kwargs):
    ...
    merchant_logger.info(f"url: {url}, payload: {payload}, response: {response}")
...
def u_map_registration(**kwargs):
    ...
    merchant_logger.info(f"Calling UMAP API ---->>> url: {url}, Response: {response}")
    admin_logger.info(f"Calling UMAP API ---->>> url: {url}, Response: {response}")
    return response
