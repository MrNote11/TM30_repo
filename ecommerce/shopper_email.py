...
def shopper_signup_verification_email(email, profile, source):
    ...
    buyer_logger.info(f"===========================================")
    admin_logger.info(
        f"shopper_signup_verification_email begin sending email to: {email}, profile: {profile}")
    buyer_logger.info(
        f"shopper_signup_verification_email begin sending email to: {email}, profile: {profile}")
    admin_logger.info(f"===========================================")
    buyer_logger.info(f"===========================================")
...
def shopper_welcome_email(email, source):
    ...
    buyer_logger.info(f"===========================================")
    admin_logger.info(
        f"shopper_welcome_email begin sending email to: {email}")
    buyer_logger.info(
        f"shopper_welcome_email begin sending email to: {email}")
    admin_logger.info(f"===========================================")
    buyer_logger.info(f"===========================================")
...
def shopper_order_status_email(order_product, source):
    ...
    buyer_logger.info(f"===========================================")
    admin_logger.info(
        f"shopper_order_status_email begin sending email to: {customer}, order_product: {order_product}")
    buyer_logger.info(
        f"shopper_order_status_email begin sending email to: {customer}, order_product: {order_product}")
    admin_logger.info(f"===========================================")
    buyer_logger.info(f"===========================================")
...
def shopper_order_placement_email(customer, order_id, order_product, source):
    ...
    data["phone_number"] = customer.user.profile.phone_number
    ...
    data["date_paid"] = order_product.payment_on
    ...
    admin_logger.info(f"===========================================")
    buyer_logger.info(f"===========================================")
    admin_logger.info(f"shopper_order_placement_email begin sending email to: {customer}, order_product: {order_product}")
    buyer_logger.info(f"shopper_order_placement_email begin sending email to: {customer}, order_product: {order_product}")
    admin_logger.info(f"===========================================")
    buyer_logger.info(f"===========================================")
    send_email(contents, email, subject)
    return True
...
def shopper_order_delivered_email(customer, order_id, order_product, source):
    ...
    buyer_logger.info(f"===========================================")
    admin_logger.info(
        f"shopper_order_delivered_email begin sending email to: {customer}, order_product: {order_product}")
    buyer_logger.info(
        f"shopper_order_delivered_email begin sending email to: {customer}, order_product: {order_product}")
    admin_logger.info(f"===========================================")
    buyer_logger.info(f"===========================================")
